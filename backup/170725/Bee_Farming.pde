...
ArrayList<Bee> trainingBees = new ArrayList<Bee>(); //for bouncer guardian
ArrayList<Firefly> trainingFireflies = new ArrayList<Firefly>(); //for royal guardian, hunting guardian, ranged guardian
ArrayList<Hornet> trainingHornets = new ArrayList<Hornet>(); //for hunting guardian, ranged guardian
ArrayList<Ladybug> trainingLadybugs = new ArrayList<Ladybug>(); //for hunting guardian
...
static final String VERSION = "Ver 17.07.25 <Pre-Alpha>";
boolean debug = false;
