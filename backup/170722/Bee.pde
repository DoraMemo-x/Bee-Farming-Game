        ...
        if (hypotenuse <= 2.0) { //pick honey
          ...
          if (_newBeeHoneyCap < maxHoneyCap) {
            ...
            if (_newFlowerHoneyGram >= 0) {
              ...
              currHoneyCap += honeyPickingSpeed;
              if (_newFlowerHoneyGram == 0) {
                flowers.remove(f);
                moveAllBees();
              ...
              increaseHoneyCap(honeyPickingSpeed+_newFlowerHoneyGram);  //this is to make up the difference of non-divisible(minusable?) flower honey
            ...
            if (_newFlowerHoneyGram > 0) {
              ...
              currHoneyCap += honeyGramPicked;
              if (_newFlowerHoneyGram == 0) {
                flowers.remove(f);
                moveAllBees();
              }
            } else if (abs(_newFlowerHoneyGram) < honeyGramPicked) {
              increaseHoneyCap(honeyGramPicked + _newFlowerHoneyGram);  //this is to make up the difference of non-divisible(minusable?) flower honey
              flowers.remove(f);                                        //after adding that difference just remove the flower like normal
              moveAllBees();                                            //flower has been emptied. Bee can move again.
            } else {
              flowers.remove(f); //divisible number. remove as normal
