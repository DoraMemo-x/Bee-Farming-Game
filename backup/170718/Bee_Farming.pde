...
static final String VERSION = "Ver 17.07.18b <Pre-Alpha>";
boolean debug = false;
...
void setup() {
  ...
  GTObjCancel = new CircleButton("C", "", width-160, height-32.5, 35, 35, 251, 200, 55, 119, 94, 26);
