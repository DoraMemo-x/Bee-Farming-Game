...
ArrayList<Firefly> trainingFireflies = new ArrayList<Firefly>(); //for royal guardian
...
static final String VERSION = "Ver 17.07.09 <Pre-Alpha>";
boolean debug = false;
...
void keyReleased() {
  ...
  case 'h':
  hornets.add(new Hornet(0));
  break;
  case 'H':
    for (int i = 0; i < 100; i++) hornets.add(new Hornet(0));
    break;
