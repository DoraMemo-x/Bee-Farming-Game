  ...
  if (beeInvSelected != -1) {
    ...
    if (!(roundOver == false && gameMillis == 0 && roundTime == 0)) {
      ...
      if (selectedBeeName.equals(upgradedBeeName[0]) && bees.get(beeInvSelected).getCDAbility()) { //if the bee is PRIEST BEE and REVIVING
        ...
        textAlign(LEFT);
        textSize(12);
        text("Reviving...", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*2);
        ...
        if (selectedB.getCDAbility() == false) {
          ...
          text("FIRST LIFE", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        } else {
          fill(undeadColour);
          text("SECOND LIFE", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        }
        ...
        if (selectedB.getCDAbility()) {
          ...
          text("Using "+char(34)+"Nature's Path"+char(34), 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        } else if (CDACooldown == 0) text(char(34)+"Nature's Path"+char(34)+" READY!", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        else text(char(34)+"Nature's Path"+char(34) + " " + 100*(beeCDAVar[2][1]-CDACooldown)/beeCDAVar[2][1] + "%", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        ...
        if (selectedB.getCDAbility()) {
          ...
          text("Using " + char(34) + "Adrenaline" + char(34), 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        } else if (CDACooldown == 0) text(char(34)+"Adrenaline"+char(34)+" READY!", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
        else text(char(34)+"Adrenaline"+char(34)+" CD.: " + CDACooldown + "s", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*3);
      }
      for (Bee b : bees) {
        if (b.getBeeName().equals(upgradedBeeName[0])) {
          if (b.getTargetBeeDistinctID() == selectedB.getDistinctID()) {
            ...
            textAlign(LEFT);
            textSize(12);
            text("Being revived...", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*2);
    ...
    if (isBeeDead[beeInvSelected]) {
      fill(200, 0, 0);
      text("THIS BEE IS DEAD.", 20 + (blockSize+10)*2.4, 70 + (blockSize+10)*2.3 + 25 + 15*6);
    }
...
void itemInventoryActive() {
  ...
  textAlign(LEFT);
  textSize(12);
  text("Viewing Resource Inventory", 25, 70 + (blockSize+10)*2 + 20);
  ...
  for (Resource r : resources) r.showItem();
